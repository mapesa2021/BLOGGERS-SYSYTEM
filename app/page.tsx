                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        {/* CTA Button */}
                        {template.id === 'business-services-pro' ? (
                          <button 
                            onClick={(e) => {
                              e.stopPropagation();
                            ...
                            className={`w-full py-2 px-4 rounded-lg text-center font-semibold text-sm transition-colors bg-gradient-to-r ${config.gradient} text-white group-hover:opacity-90`}
                          >
                            Copy Fixed Link
                          </button>
                        ) : (
              ...
              <div className="space-y-6">
                ...
                <button
                  onClick={async () => {
                    ...
                    const pageId = selectedTemplate === 'business-services-pro'
                      ? `107-1757-business-services-pro-fixed`
                      : selectedTemplate === 'modern' 
                ...
                {generatedUrl && (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    ...
                    <div className="mt-3 flex space-x-3">
                      {selectedTemplate === 'business-services-pro' ? (
                        <>
                          <button
                            onClick={() => {
                            ...
                            className="copy-link-btn px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors text-center"
                          >
                            Copy Link
                          </button>
                          <a
